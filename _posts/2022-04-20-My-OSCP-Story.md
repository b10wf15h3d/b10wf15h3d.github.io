...
> Pre-schedule your `breaks` before taking the exam but remember it's fluid.
{: .prompt-tip }

> `Sleep` is important, treat the exam like a working day.
{: .prompt-tip }
...
If you've read the course PDF then yes you have the neccessary knowledge to pass the Active Directory section.
